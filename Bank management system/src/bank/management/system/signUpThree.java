...
public class signUpThree extends JFrame implements ActionListener{
    ...
    signUpThree(String formno){
        ...
        c7 = new JCheckBox("I Hereby declares thet the above entered details are correct to the best ofmy knowledge");
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Raleway",Font.BOLD,16));
        c7.setBounds(100,560,800,30);
        add(c7);
       ...
       submit.setBounds(250,600,100,30);submit.addActionListener(this);
       add(submit);
